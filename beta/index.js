...
document.querySelector(".download-result").style.animation="slideup 0.75s"; document.querySelector(".hidedown").style.display="flex";document.querySelector(".solid2").style.display="none";document.querySelector(".showdown").style.display="none";}
	...
	$( "#clear-editor" ).before( $( "<button id='turbo-btn1' class='turbo_btn'><svg t='1733635622782' class='icon' style='width:20px' viewBox='0 0 1024 1024' version='1.1' xmlns='http://www.w3.org/2000/svg' p-id='9132' id='mx_n_1733635622783' width='200' height='200'><path d='M771.3 465.8L256 1024l150.1-450.3c1.7-5.2-2.1-10.5-7.6-10.5H253c-46.5 0-77.5-48.1-58.3-90.5L392.5 37.5C402.9 14.7 425.7 0 450.8 0h419.6L672.5 346.4c-3 5.3 0.8 12 6.9 12h44.8c55.8 0 84.9 66.4 47.1 107.4z' p-id='9133' fill='#fff'></path></svg>FAST MODE<p class='turbo_nonactive' style='color:#ff3333;margin-left:3px;'>●</p><p class='turbo_active' style='display:none;color:#66ff33;margin-left:3px;'>●</p></button>" ) );
	$( "#clear-editor" ).before( $( "<button id='turbo-btn2' class='turbo_btn'><svg t='1733635622782' class='icon' style='width:20px' viewBox='0 0 1024 1024' version='1.1' xmlns='http://www.w3.org/2000/svg' p-id='9132' id='mx_n_1733635622783' width='200' height='200'><path d='M771.3 465.8L256 1024l150.1-450.3c1.7-5.2-2.1-10.5-7.6-10.5H253c-46.5 0-77.5-48.1-58.3-90.5L392.5 37.5C402.9 14.7 425.7 0 450.8 0h419.6L672.5 346.4c-3 5.3 0.8 12 6.9 12h44.8c55.8 0 84.9 66.4 47.1 107.4z' p-id='9133' fill='#fff'></path></svg>FAST MODE<p class='turbo_nonactive' style='color:#ff3333;margin-left:3px;'>●</p><p class='turbo_active' style='display:none;color:#66ff33;margin-left:3px;'>●</p></button>" ) );	
...
$("#active_server2").hide();
	...
	$(document).on("click",
        ...
        async function() {
			...
			inputEditor.setValue(textvalue);		
        });
	$(document).on("click",
        "#copy_clip",
