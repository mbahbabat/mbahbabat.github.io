const errorEmailOverlay = document.getElementById("error-email-overlay"),
	...
	outputection = document.getElementById("output-section"),
    ...
    closeModeBtn = document.getElementById("close-mode-btn"),
...
const domHelpers = {
        ...
        updateSpecs: () => {
            ...
            const a = {
                ...
                balance: {
                    ...
                    status: 'Mode: <i class="fa-solid fa-circle" style="color:#ffff00"></i>',
                    style: "box-shadow: 0 0 2px rgba(255, 255, 0, 0.5); border-left: 2px solid #ffff00;"
                },
                slow: {
                    ...
                    status: 'Mode: <i class="fa-solid fa-circle" style="color:#53ff1a"></i>',
                    style: "box-shadow: 0 0 2px rgba(0, 255, 0, 0.5); border-left: 2px solid #53ff1a;"
                }
            };
    ...
    workerUtils = {
        ...
        finishTask: async e => {
            if (!accessToken) return void console.error("Unauthorized");
			if (!appConfig ||terminatedProcess) return;
    ...
    taskUtils = {
        ...
        startNextBatch: async () => {
            if (!isProcessing ||terminatedProcess || isBatchCurrentlyActive || currentEmailQueueIndex >= emailQueue.length) return;
    ...
    resetUtils = {
        ...
        ui: () => {
			...
			landingPage.addEventListener("scroll", function() {
				if (landingPage.scrollTop > 100) {
					domHelpers.setStyle(landingPage, "position: absolute; top:0; left:0; background: linear-gradient(90deg, #47476b, #9494b8); padding: 100px 25px 25px 25px; border-radius: 5px; border: 3px solid #5900b3; "),
					domHelpers.removeClass(scrollToTop, "hidden")
				} else {
					domHelpers.setStyle(landingPage, ""),
					domHelpers.addClass(scrollToTop, "hidden")
				}
			}),
...
function setupEventListeners() {
    generateBtn.addEventListener("click", (async function() {
        ...
        if (0 !== e.length) {
            ...
            }), 1e3), taskUtils.startNextBatch(), uiUtils.updateGlobalProgress()
        } else alert("Please enter at least one email!")
    })), stopBtn.addEventListener("click", (async function() {
        for (let e of activeWorkers.values()) e.terminate();
        activeWorkers.clear(), currentProcessingBatch.clear(), isProcessing = !1,  isBatchCurrentlyActive = !1, currentEmailQueueIndex = 0, terminatedProcess = !0, uiUtils.updateGlobalProgress()
		...
		domHelpers.removeClass(modeSelection, "hidden"),
        domHelpers.setStyle(modeSelection, "display: flex; position: absolute; top:0; left:0; background: linear-gradient(90deg, #47476b, #9494b8); padding: 25px; border-radius: 5px; border: 3px solid #5900b3; z-index: 1000 ")
	}),
	closeModeBtn.addEventListener("click", () => {
		domHelpers.setStyle(modeSelection, ""),
		domHelpers.addClass(modeSelection, "hidden")
