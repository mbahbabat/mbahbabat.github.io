...
$( ".header_top" ).after( $( "<div class='header_bottom' style='width:100%;display:flex;justify-content:center;position:relative'>" ) );
$( ".header_bottom" ).after( $( "<div class='header_bottom2' style='width:100%'>" ) );
...
$( ".header_bottom2" ).append( $( "<div class='indi_progress'>" ) );
$( ".indi_progress" ).append( $( "<div class='progress progress-lg'>" ) );$( ".progress" ).prepend( $( "<div id='mail-progress-bar' class='progress-bar progress-bar-striped' role='progressbar' style='width: 0%;' aria-valuenow='25' aria-valuemin='0' aria-valuemax='100'>0%</div>" ) );

 $( ".result" ).append( $( "<div class='mailinput' style='display:flex;flex-direction:column;width:50%;height:100%;padding:0px 5px 0px 0px'>" ) );
