...
const toastrminjs = document.createElement('script');
    toastrminjs.setAttribute("src", "toastr.min.js");
    document.body.appendChild(toastrminjs);
	
const abptoastrjs = document.createElement('script');
    abptoastrjs.setAttribute("src", "abp.toastr.js");
    document.body.appendChild(abptoastrjs);	
